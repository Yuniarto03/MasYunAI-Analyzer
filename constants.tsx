...
export const SIDEBAR_SECTIONS: SidebarSectionConfig[] = [
  {
    ...
    items: [
      ...
      { name: "Google Drive", icon: CloudIcon, viewId: 'onlineConnectors' }, 
      { name: "Dropbox", icon: CloudIcon, viewId: 'onlineConnectors' }, 
      { name: "BigQuery", icon: TableIcon, viewId: 'onlineConnectors' }, 
      { name: "Snowflake", icon: TableIcon, viewId: 'onlineConnectors' }, 
    ]
  },
  {
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Insight Generator", icon: WandIcon, viewId: 'advancedAITools' },
      { name: "Predictive Modeler", icon: WandIcon, viewId: 'advancedAITools' },
      { name: "Anomaly Detection", icon: WandIcon, viewId: 'advancedAITools' },
    ]
  }
];
